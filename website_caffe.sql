...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th4 12, 2023 lúc 06:32 PM
...
(25, 'q8b5x', '30', 'ngod00586@gmail.com', 1, 0);
...
INSERT INTO `tbl_menu` (`id_menu`, `tenmenu`, `thutu`, `parent_id`) VALUES
(17, 'Cafe', 1, 0),
(24, 'Sinh tố', 2, 0),
(26, 'Sữa chua', 3, 0);
...
(39, 'Dducky', 'ngod00586@gmail.com', '0965840200', 'ssssssssss', '$2y$10$wrueR8VwLqGe5Fweo5ml8effsdrmTnDDDSoQBMwEiQZD/zsVQkwr2', '', 0, 0, 'verified', '');
...
--
ALTER TABLE `tbl_magiam`
  MODIFY `id_magiam` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=26;
...
--
ALTER TABLE `tbl_taikhoan`
  MODIFY `id_taikhoan` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=40;
